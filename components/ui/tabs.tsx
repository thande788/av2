  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-primary/10 data-active:text-primary data-active:border-primary/30",
        "dark:data-active:bg-primary/10 dark:data-active:text-primary dark:data-active:border-primary/30",
